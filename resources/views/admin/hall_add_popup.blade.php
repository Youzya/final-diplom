      ...
      <div class="popup__header">
        <h2 class="popup__title">
          ...
          <a class="popup__dismiss">
            <img src="{{url('/assets/admin/i/close.png')}}" alt="Закрыть" onclick="switchPopup(document.getElementById('hall-add-popup'))">
          </a>
        </h2>
      </div>
      <div class="popup__wrapper">
        <form action="add_hall" method="post" accept-charset="utf-8">
          ...
          <div class="conf-step__buttons text-center">
            ...
            <button type="button" class="conf-step__button conf-step__button-regular" onclick="switchPopup(document.getElementById('hall-add-popup'))">Отменить</button>
          </div>
        </form>
      </div>
    </div>
