    ...
    <section class="login">
      ...
      <div class="login__wrapper">
        <form class="login__form" method="POST" action="{{ route('login') }}">
            ...
            E-mail
            <input id="email" type="email" class="login__input" name="email" value="{{ old('email') }}" placeholder="example@domain.xyz" required autocomplete="email" autofocus>
                @error('email')
            ...
            Пароль
            <input id="password" type="password" class="login__input" name="password" required autocomplete="current-password">
                @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
